...
files=['VERSION','README.md','LICENSE','CONTRIBUTING.md','config.example.json','manage.py','verify.py','install.sh','uninstall.sh',
       ...
       'scripts/verify_remote_syslog.py','scripts/benchmark_syslog.py','tests/test_syslog.py','tests/test_timezones.py','tests/test_guard_recovery.py','tests/test_upgrade.py','tests/integration/test_rsyslog.py','tests/test_agent.py','tests/test_portable.py',
       'docs/CONFIGURATION.md','docs/OPERATIONS.md','docs/IMMORTALWRT.md','docs/PVE.md','docs/SYSLOG-DESIGN.md','docs/SYSLOG-ACCEPTANCE.md','docs/UPGRADE-v1.2.md','docs/PVE-ROADMAP.md','docs/V1.2-REPORT.md','docs/PR1-REVIEW-FIXES.md']
